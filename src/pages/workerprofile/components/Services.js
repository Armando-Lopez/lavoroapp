            ...
            fileRef
                ...
                .then(() => {
                    db.collection("workers")
                        .doc(uid)
                        .update({
                            photos_services: firebase.firestore.FieldValue.arrayRemove(
                                url
                            ),
                        })
                        .then(() => {
                ...
                .catch(() => {
                    M.toast({
                        html:
                            "No pudimos eliminar la foto. intentalo más tarde.",
                    });
                });
        }
    };
            ...
            <div className="services-cnt">
                {photos_services.map((item, index) => {
                    return (
                        <div
                            key={index}
                            className="card center-align z-depth-2 service"
                        >
                            <img
                                src={item}
